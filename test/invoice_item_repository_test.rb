...
class InvoiceItemRepositoryTest < Minitest::Test
  def setup
    invoice_item_one = Merchant.new {id: "1", item_id: "5", invoice_id: "10", quantity: "9", unit_price: "78", created_at: "a", updated_at: "w" }
    invoice_item_two = Merchant.new {id: "2", item_id: "8", invoice_id: "30", quantity: "2", unit_price: "89", created_at: "a", updated_at: "k" }
    invoice_item_three = Merchant.new {id: "3", item_id: "2", invoice_id: "20", quantity: "4", unit_price: "55", created_at: "b", updated_at: "w" }
