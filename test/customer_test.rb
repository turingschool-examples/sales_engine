...
class CustomerTest < Minitest::Test
  ...
  def setup
    ...
    @transaction1 = Transaction.new(invoice_id: 1, result: 'success', invoice: @invoice)
    @transaction2 = Transaction.new(invoice_id: 1, result: 'failed',  invoice: @invoice)
    @transaction3 = Transaction.new(invoice_id: 2, result: 'success', invoice: @invoice2)
    @transaction4 = Transaction.new(invoice_id: 3, result: 'success', invoice: @invoice3)
